...
{ 
  ...
  /*soft_serial.println("début du x");
  for (int j = -75; j<=50; j=j+5){
    calculeEtAffiche(j, -65, -120);
    soft_serial.print("x = ");
    soft_serial.println(j);
    delay(1000);
  }
  soft_serial.println("fin du x");
  delay(1000);*/


  calculeEtAffiche(-75, -30, -120);
  delay(1000);
  calculeEtAffiche(-75, -65, -120);
  delay(1000);
  digitalWrite(4, HIGH);
  delay(200);
  calculeEtAffiche(-75, -30, -120);
  delay(1400);
  calculeEtAffiche(50, -30, -120);
  delay(1000);
  digitalWrite(4, LOW);
  delay(5000);
