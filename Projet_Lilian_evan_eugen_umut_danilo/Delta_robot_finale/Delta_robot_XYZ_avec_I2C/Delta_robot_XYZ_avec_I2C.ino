...
void loop() 
{ 
  calculeEtAffiche(pos1.x, pos1.y, pos1.z);
  delay(1000);
  calculeEtAffiche(pos2.x, pos2.y, pos2.z);
  delay(1000);
  digitalWrite(4, HIGH);
  delay(200);
  calculeEtAffiche(pos1.x, pos1.y, pos1.z);
  delay(1400);
  moveLinear(pos1.x, pos1.y, pos1.z, pos3.x, pos3.y, pos3.z, 20, 50);
  digitalWrite(4, LOW);
  delay(5000);
}
