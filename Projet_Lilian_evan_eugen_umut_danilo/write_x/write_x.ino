...
const uint8_t DXL_ID = 0;           // ID du premier servo
const uint8_t DXL_ID1 = 1;           // ID du second servo
...
void loop() {
    ...
    // --- Premier servomoteur ---
    DEBUG_SERIAL.print("Servo 1 mouvement vers : 0");
    dxl.setGoalPosition(DXL_ID, 0);
    delay(1500);

    // Déclaration et première lecture
    ...
    // --- Deuxième servomoteur ---
    DEBUG_SERIAL.print("Servo 2 mouvement vers : 0");
    dxl.setGoalPosition(DXL_ID1, 0);
    delay(1500);
    
    // ICI : On ne réécrit pas "int32_t", on utilise juste "pos"
